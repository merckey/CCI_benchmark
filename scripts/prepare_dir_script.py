...
def generate_dir_script(count_path, count_raw_path, meta_path, 
    ...
    cc_command = 'screen -x cellchat -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_cc.R -c {} -m {} -o {}/cc/output/ > {}/cc/script/cc_nohup.out 2>&1 &\\n"'.format(data_base_dir, count_path_short, meta_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    # cpdb_command = 'screen -x cpdb -p 0 -X stuff "cd {} && nohup time -v cellphonedb method statistical_analysis {} {} --counts-data gene_name --output-path {}/cpdb/output --threads 4 --database /home/mcc/.cpdb/releases/v2.0.0/cellphone.db > {}/cpdb/script/cpdb_nohup.out 2>&1 &\\n"'.format(data_base_dir, meta_path_short, count_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    cpdb_command = 'screen -x cpdb_v3 -p 0 -X stuff "cd {} && nohup time -v cellphonedb method statistical_analysis {} {} --counts-data gene_name --output-path {}/cpdb_v3/output --threads 4 --database /home/mcc/.cpdb/releases/v2.0.0/cellphone.db > {}/cpdb_v3/script/cpdb_nohup.out 2>&1 &\\n"'.format(data_base_dir, meta_path_short, count_path_short, tool_output_dir_short, tool_output_dir_short)

    with open('{}/cpdb_v3/script/submit_cpdb.sh'.format(tool_output_dir),'w') as f:
        f.write(cpdb_command)
        
    os.system('chmod 777 {}/cpdb_v3/script/submit_cpdb.sh'.format(tool_output_dir))
    ...
    # italk_command = 'screen -x italk -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_italk.R -c {} -m {} -o {}/iTALK/output/ > {}/iTALK/script/italk_nohup.out 2>&1 &\\n"'.format(data_base_dir, count_path_short, meta_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    # scr_command = 'screen -x scr -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_scr_cutoff_refine.R -c {} -m {} -o {}/SCR/output/ -s 0.6 > {}/SCR/script/scr_nohup.out 2>&1 &\\n"'.format(data_base_dir, count_path_short, meta_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    # icellnet_command = 'screen -x icellnet -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_icellnet_refine.R -c {} -m {} -o {}/icellnet/output/ > {}/icellnet/script/icellnet_nohup.out 2>&1 &\\n"'.format(data_base_dir, count_path_short, meta_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    # nichenet_command = 'screen -x nichenet -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_nichenet.R -c {} -m {} -o {}/NicheNet/output/ > {}/NicheNet/script/nichenet_nohup.out 2>&1 &\\n"'.format(data_base_dir, count_path_short, meta_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    # cytotalk_command = 'python /home/mcc/CCI-main/scripts/prepare_input_cytotalk.py -c {} -m {} -o {} && cd {}/CytoTalk/script/ && nohup time -v ./run_cytotalk.sh > {}/CytoTalk/script/cytotalk_nohup.out 2>&1 &'.format(count_path, meta_path, tool_output_dir, tool_output_dir, tool_output_dir)
    ...
    ## scmlnet_command = 'screen -x scmlnet -p 0 -X stuff "nohup time -v Rscript /home/mcc/CCI-main/scripts/run_scmlnet.R -c {} -m {} -o {}/scmlnet/output/ -n {} > {}/scmlnet/script/scmlnet_nohup.out 2>&1 &\\n"'.format(count_raw_path, meta_path, tool_output_dir, 4, tool_output_dir)
    ...
    # scmlnet_command = 'sed \'1 iBarcode\tCluster\' {} > {}/scmlnet/scmlnet_meta.tsv && python /home/mcc/CCI-main/scripts/prepare_input_scmlnet.py -c {} -m {}/scmlnet/scmlnet_meta.tsv -o {} -t 1 && cd {}/scmlnet/script/ && nohup time -v ./run_scmlnet.sh > {}/scmlnet/script/scmlnet_nohup.out 2>&1 &'.format(meta_path, tool_output_dir, count_raw_path, tool_output_dir, tool_output_dir, tool_output_dir, tool_output_dir)
    ...
    # connectome_command = 'screen -x connectome -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_connectome.R -c {} -m {} -o {}/Connectome/output/ > {}/Connectome/script/connectome_nohup.out 2>&1 &\\n"'.format(data_base_dir, count_path_short, meta_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    # prepare_scenic_command = "python /home/mcc/CCI-main/scripts/prepare_scenic_input.py -c {} -o {}".format(count_raw_path, os.path.join(tool_output_dir,'Domino','SCENIC','scenicdata','counts.tsv'))
...
#     domino_prepare_script = "Rscript /home/mcc/CCI-main/scripts/prepare_domino_input.R -c {} -m {} -o {}".format(count_raw_path, meta_path, os.path.join(data_base_dir,'data','processed','sc_res.rds'))
...
#     domino_script = 'screen -x domino -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_domino.R -r ./data/processed/sc_res.rds -s ./tools/Domino/SCENIC/scenicdata -f n -o ./tools/Domino/output/ > ./tools/Domino/script/Domino_nohup.out 2>&1 &\n"'.format(data_base_dir)
...
#     os.system('chmod 777 {}/Domino/script/submit_Domino.sh'.format(tool_output_dir))
    ...
    # cellcall_script = 'screen -x cellcall -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_cellcall.R -c {} -m {} -o {}/CellCall/output > ./tools/CellCall/script/CellCall_nohup.out 2>&1 &\n"'.format(data_base_dir,count_raw_path_short,meta_path_short,tool_output_dir_short)
    ...
    # stlearn_script = 'screen -x stlearn -p 0 -X stuff "cd {} && nohup time -v python /home/mcc/CCI-main/scripts/run_stlearn.py -c {} -p {} -d {} -o ./tools/stlearn/output > ./tools/stlearn/script/stlearn_nohup.out 2>&1 &\n"'.format(data_base_dir, st_count_path_short, st_coord_path_short, deconv_path_short)
    ...
    giotto_script = 'screen -x giotto -p 0 -X stuff "cd {} && nohup time -v Rscript /home/mcc/CCI-main/scripts/run_giotto.R -c {} -m {} -p {} -o {}/Giotto/output > {}/Giotto/script/Giotto_nohup.out 2>&1 &\n"'.format(data_base_dir,st_count_path_short,st_meta_path_short, st_coord_path_short, tool_output_dir_short, tool_output_dir_short)
    ...
    ip_dis_script = 'cd {} && nohup python /home/mcc/CCI-main/scripts/prepare_ip_dis_sinkhorn2.py -c {} -p {} -o {} &'.format(os.path.join(data_base_dir,'data','ip_dis_sinkhorn2'),st_count_path, st_coord_path, os.path.join(data_base_dir,'data','ip_dis_sinkhorn2'))
